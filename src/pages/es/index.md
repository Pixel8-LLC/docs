...
To get started, you only have to a github account and open the link [https://gitpod.io/#https://github.com/blockstack/docs](https://gitpod.io/#https://github.com/blockstack/docs) in your browser.
...
If you are interested in only adding new documentation content to the site, the files that will be important to you are located within `docs.blockstack/src/pages/*`:
